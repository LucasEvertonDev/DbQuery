...
namespace DB.Query.Tests.Versions.v1
{
    ...
    public class DominioRepository : DBQueryPersistenceExample
    {
        ...
        public void CountMethod()
        {
            ...
            Assert.AreEqual(query, "SELECT COUNT(*) AS Count FROM SignCi..CiDominio WHERE ((CiDominio.Codigo > 1 AND CiDominio.Descricao LIKE '%TESTE_LIKE%') AND CiDominio.Nome IS NOT NULL)");
        }
